...
def get_debug_args():
    ...
    parser.add_argument("--rader", type=bool, default=True)
...
def get_sort_args():
    ...
    parser.add_argument("--cmc-method", default="orb", type=str, help="cmc method: files (Vidstab GMC) | orb | ecc")
    # ReID
    parser.add_argument("--with-reid", dest="with_reid", default=False, action="store_true", help="test mot20.")         #TODO 원본 git 저장소에서 누락된 파일 가져오기 !김현수!조민희!
