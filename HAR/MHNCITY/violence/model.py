...
class TemporalDynamicGCN(nn.Module):
    ...
    def forward(self, all_keypoint_batches):
        ...
        # print(f"LSTM OUT : {lstm_output}")
        """
        LSTM OUT : tensor([[-1.5973e-02, -8.2302e-04, -3.2536e-03,  ...,  2.4938e-02,
         -6.7759e-03,  3.0963e-02],
        [-1.5973e-02, -8.2302e-04, -3.2536e-03,  ...,  2.4938e-02,
         -6.7759e-03,  3.0963e-02],
        [-1.5973e-02, -8.2302e-04, -3.7191e-03,  ...,  9.3527e-01,
          1.5721e-01,  2.2472e-02],
        ...,
        [-2.0836e-01, -5.5203e-01, -6.0889e-03,  ...,  9.5362e-01,
          2.3121e-01, -3.6582e-03],
        [-2.0186e-01, -5.9451e-01, -2.6992e-03,  ...,  9.6195e-01,
          2.5522e-01, -2.0753e-03],
        [-2.0033e-01, -6.3031e-01, -1.5389e-03,  ...,  9.6608e-01,
          2.8166e-01, -1.3921e-03]], device='cuda:0')
        LSTM OUT : tensor([[-1.3267e-02, -8.4588e-03, -1.0385e-02,  ...,  4.1800e-02,
          4.6498e-02,  8.9085e-03],
        [-1.3267e-02, -8.4588e-03, -1.0385e-02,  ...,  4.1800e-02,
          4.6498e-02,  8.9085e-03],
        [-3.7593e-05, -8.4588e-03,  2.5016e-06,  ...,  1.7476e-02,
          2.0925e-02,  7.3091e-03],
        ...,
        [ 1.3272e-05, -1.5043e-01,  2.2588e-06,  ..., -1.5874e-01,
         -3.2612e-03, -6.3871e-01],
        [ 5.9836e-06, -1.6294e-01,  1.0521e-06,  ..., -1.5242e-01,
         -2.4136e-03, -6.5810e-01],
        [ 2.4832e-06, -1.7595e-01,  5.8070e-07,  ..., -1.5080e-01,
         -1.9711e-03, -6.7382e-01]], device='cuda:0')
        """
