...
from BoTSORT.yolov7.utils.google_utils import gsutil_getsize
from BoTSORT.yolov7.utils.metrics import fitness
from BoTSORT.yolov7.utils.torch_utils import init_torch_seeds
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        # obj_conf = x[:, 4:5]
        # x[:, 5:] = x[:, 4:5]
        x[:, 5:] *= x[:, 4:5]  # conf = obj_conf * cls_conf , obj_conf가 bbox score라고 보면 됨. 원본코드
    ...
    return output #, obj_conf # obj_conf = bbox score = detection score
