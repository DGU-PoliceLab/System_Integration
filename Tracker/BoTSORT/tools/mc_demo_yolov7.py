...
def detect(save_img=False):
    ...
    for i in range(len(detections)):
        if detections[i][5] == 0:
            det_results.append(detections[i][:4])
        elif detections[i][5] == 1:
            face_bboxes.append(detections[i][:4])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='./test_data/1_18_1.mp4', help='source')  # file/folder, 0 for webcam
